...
`
	...
	bytes, err := Generate(columnMap, []string{"test_table"}, "testStruct", "test", "", false, false, false)
...
`
	...
	bytes, err = Generate(columnMap, []string{"test_table"}, "testStruct", "test", "", false, false, true)
...
`
	...
	bytes, err := Generate(columnMap, []string{"test_table"}, "testStruct", "test", "", true, false, false)
...
`
	...
	bytes, err := Generate(columnMap, []string{"test_table"}, "testStruct", "test", "", false, true, false)
